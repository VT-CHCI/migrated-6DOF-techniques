...
XOffset = miniObjParent.getMatrix()
...
wimDummyObject.parent(objParent)
temp = False
...
def formatIntersectResults(rawList):
	...
	for elem in rawList:
		...
		if ((elem.object != ray) and (elem.object != room) and (elem.object != controller) and (not temp.count(elem.object))):
