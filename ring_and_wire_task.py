...
ring_piece0 = viz.add('models/ring_section0.obj',parent=ring)
ring_piece1 = viz.add('models/ring_section1.obj',parent=ring)
ring_piece2 = viz.add('models/ring_section2.obj',parent=ring)
ring_piece3 = viz.add('models/ring_section3.obj',parent=ring)
ring_piece4 = viz.add('models/ring_section4.obj',parent=ring)
ring_piece5 = viz.add('models/ring_section5.obj',parent=ring)
ring_piece6 = viz.add('models/ring_section6.obj',parent=ring)
ring_piece7 = viz.add('models/ring_section7.obj',parent=ring)

ring_piece1.setEuler(45,0,0)
ring_piece2.setEuler(90,0,0)
ring_piece3.setEuler(135,0,0)
ring_piece4.setEuler(180,0,0)
ring_piece5.setEuler(-135,0,0)
ring_piece6.setEuler(-90,0,0)
ring_piece7.setEuler(-45,0,0)
...
ring.collideSphere(node='Torus.000')
ring.collideSphere(node='Torus.001')
ring.collideSphere(node='Torus.002')
ring.collideSphere(node='Torus.003')
ring.collideSphere(node='Torus.004')
ring.collideSphere(node='Torus.005')
ring.collideSphere(node='Torus.006')
ring.collideSphere(node='Torus.007')

spring = ring.addSpring(viz.LINK_POS,linearKd=20,linearKs=200)
spring.setLinearKd(5) # Change Kd
spring.setLinearKs(100) # Change Ks
spring.setPosition(ring.getPosition())

box = viz.add( 'white_ball.wrl' )
box.alpha( .2 )
box.color( viz.RED )

print ring.getNodeNames()
...
def updateScene():
	...
	if attached:
		...
		spring.setQuat(virtualHand.getQuat())
		...
		spring.setPosition(virtualHand.getPosition())
